...
import VoteButton from '../components/Trading/VoteButton';
import Chat from '../components/Trading/Chat';
    ...
    <div className="px-4 py-8">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl"
              >
              ...
              <VoteButton 
                marketId={market.id} 
                initialUpvotes={market.upvotes || 0}
                initialDownvotes={market.downvotes || 0}
              />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {chatExpanded && (
            <div ref={chatRef} className="animate-fadeIn">
              <Chat 
                marketId={market.id} 
